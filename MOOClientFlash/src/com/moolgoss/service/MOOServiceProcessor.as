...
package com.moolgoss.service {
  ...
  public class MOOServiceProcessor extends TProcessor {

    private var iface_:IMOOService;

    public function MOOServiceProcessor(iface:IMOOService, iprot:TProtocol, oprot:TProtocol=null)
    {
      super(iprot,oprot);
      iface_ = iface;
